...
c = 0.8 # document split location (= percentage range from middle) parameter
...
def split_big_docs(doc_L, identifer_L):
	...
	return doc_L2, identifer_L2 # if len(doc_L2) == 1, that means split failed

def split_unit(unit, splitpoint_regexes = doc_splitpoint_regexes, max_len = b):
	"""
